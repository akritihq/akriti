...
# The appendix's own prose, hoisted out of the list it is spliced into so that
# it sits at column zero: as list elements these paragraphs are indented past
# the line-length limit, and rewrapping them would change the published text.
_PREAMBLE = """\
